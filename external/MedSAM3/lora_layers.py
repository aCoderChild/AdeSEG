...
def load_lora_weights(model: nn.Module, load_path: str, map_location=None):
    """
    ...
    Args:
        ...
        map_location: Optional device mapping for CPU/MPS/CUDA portability.
    """
    lora_state_dict = torch.load(load_path, map_location=map_location)
