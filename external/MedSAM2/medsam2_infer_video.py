...
def vos_inference(
    ...
    video_name,
    score_thresh=0.0,
    use_all_masks=False, # only the mask of the first frame
...
def main():
    ...
    parser.add_argument(
        "--sam2_checkpoint",
        type=str,
        default="checkpoints/checkpoints/MedSAM2_latest.pt",
    ...
    parser.add_argument(
        ...
        "--base_video_dir",
        type=str,
        default="data/polypgen_vid_seq/seq2/images",
        help="directory containing videos (as JPEG files) to run inference on", # videos as JPEG files
    )
    parser.add_argument(
        "-m",
        "--input_mask_dir",
